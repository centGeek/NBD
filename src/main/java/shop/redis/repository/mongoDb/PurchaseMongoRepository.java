...
public class PurchaseMongoRepository extends AbstractMongoRepository {
    ...
    public PurchaseMongoRepository() {
    ...
    public PurchaseMongoRepository(String nameOfColletion) {
        this.database = AbstractMongoRepository.getDatabase();
    ...
    protected static final Logger logger = LogManager.getLogger(PurchaseMongoRepository.class);
