...
public class StockMongoRepository extends AbstractMongoRepository {

    private final MongoDatabase database;
    private final String nameOfCollection;

    public StockMongoRepository() {
    ...
    public StockMongoRepository(String nameOfCollection) {
        this.database = AbstractMongoRepository.getDatabase();
    ...
    protected static final Logger logger = LogManager.getLogger(StockMongoRepository.class);
